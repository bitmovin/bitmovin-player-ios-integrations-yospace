...
class ViewController: UIViewController {
    ...
    lazy var streams = [
        Stream(
            title: "Metadata fix",
            contentUrl: "https://csm-e-sdk-validation.bln1.yospace.com/csm/extlive/yospace02,hlssample42.m3u8?yo.br=true&yo.lp=true&yo.av=4",
...
extension ViewController: PlayerListener {
    ...
    func onError(_ event: SourceErrorEvent) {
