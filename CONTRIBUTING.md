...
- Validate your changes according to the [Yospace Validation Procedure](https://developer.yospace.com/sdk-documentation/apple/userguide/latest/en/validate-your-app.html).
